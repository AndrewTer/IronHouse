...
<body>
<!--<div id="ajaxLoadingContainer">
    <div id="ajaxLoading"></div>
</div>
<div id="modalDialog1" class="ui-widget">
    <div id="modalDialogTips1"></div>
    <div id="modalDialogContent1" style="overflow: auto;"></div>
</div>-->
<div class="layoutMain">
<!--<div class="blockx"><p  id="text" align="center">Автоматизация парковок</p></div> -->
...
<div class="footer">
	<div class="hood">
		<!--&copy;&nbsp;2009-2016&nbsp;Кинотеатр&nbsp;Художественный-->
	</div>
	</div>
